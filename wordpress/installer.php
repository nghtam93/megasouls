...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211225_megasouls_ecfce2200de184fa7612_20211225052940_archive.zip';
	const ARCHIVE_SIZE		 = '60268380';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ecfce22-25052940';
    const SECONDARY_PACKAGE_HASH = '4ef50e0-25052940';
	const VERSION			 = '1.4.3';
